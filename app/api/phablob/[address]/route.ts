...
<svg width="800" height="800" viewBox="0 0 800 800" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <!-- Встроенный шрифт DejaVu Sans Bold -->
    <style type="text/css">
      @font-face {
  ...
  <!-- ВОДЯНЫЕ ЗНАКИ (используем один элемент text с tspans для оптимизации) -->
