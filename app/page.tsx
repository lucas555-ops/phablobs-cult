...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* STICKY NAVBAR */}
      <StickyNavbar pageTitle="Your Wallet. Your Masterpiece." />

      {/* MAIN CONTENT - с отступом для навбара */}
      <div className="pt-20">
        {/* Background Effects */}
        ...
        {/* Header with Logo - СКРЫТ, так как в навбаре */}
        {/* Раньше был <header> с логотипом, теперь это в StickyNavbar */}
        ...
        <div className="space-y-12 mt-20">
          ...
          <footer className="max-w-6xl mx-auto pt-12 pb-12 border-t border-[#ab0ff2]/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-8">
              ...
              <div className="flex flex-col items-center md:items-start">
                ...
                <p className="text-xs text-gray-500 text-center md:text-left">
                  Phantom-inspired avatar generator
                </p>
                <p className="text-xs text-gray-600 mt-2 text-center md:text-left">
                  © {new Date().getFullYear()} phablobs.xyz
                </p>
              </div>

              {/* Center - Creator */}
              <div className="flex flex-col items-center justify-start">
                <p className="text-sm font-bold text-white mb-1">Cooked by</p>
                <p className="text-2xl font-black bg-gradient-to-r from-[#ab0ff2] to-[#4da7f2] bg-clip-text text-transparent mb-2">
                  Blobmaster
                </p>
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-gray-800/30 rounded-lg text-[#4da7f2] hover:text-[#ab0ff2] hover:bg-gray-800/50 transition-all"
                >
              ...
              <div className="flex flex-col items-center md:items-end">
                ...
                <div className="flex items-center gap-3">
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 bg-gray-800/30 rounded-full flex items-center justify-center text-gray-400 hover:text-[#1DA1F2] hover:bg-[#1DA1F2]/20 transition-all hover:scale-110"
                    title="X / Community"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417a9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                  ...
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 bg-gray-800/30 rounded-full flex items-center justify-center text-gray-400 hover:text-[#0088cc] hover:bg-[#0088cc]/20 transition-all hover:scale-110"
                    title="Telegram"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Divider */}
            <div className="h-px bg-gradient-to-r from-transparent via-[#ab0ff2]/30 to-transparent my-8" />

            {/* Bottom Section - Legal & Fun Note */}
            <div className="flex flex-col items-center text-center space-y-2">
              <p className="text-xs text-gray-600">
                All rights reserved. Not affiliated with Phantom Wallet. For entertainment purposes only.
              </p>
